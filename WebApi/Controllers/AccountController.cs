...
namespace WebApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        [HttpGet]
        [Route("LocalUserInfo")]
        public async Task<UserInfoViewModel> GetLocalUserInfo()
        {
        ...
        [HttpGet]
        [Route("Tenants")]
        public async Task<IEnumerable<UserData>>  GetTenants()
        {
            var data = await UserManager.Users.Select(u => new UserData
            {
